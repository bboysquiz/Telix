...
<body>
    ...
    <section class="content-changePassword">
        <div class="content-changePassword__container">
            <h2 class="content-changePassword__title">Смена пароля</h2>

            <div class="content-changePassword__form">
                <h3 class="content-changePassword__form-title">Введите новый пароль</h3>
                <input type="text" class="content-changePassword__form-input">
                <div class="content-changePassword__form-button-wrapper">
                    <button class="content-changePassword__form-button">Сохранить</button>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="popup-changePassword__layer"></div>
    <div class="popup-changePassword">
        <div class="popup-changePassword__container">
            <h3 class="popup-changePassword__text">
                Вы уверены, что хотите сменить пароль?
            </h3>
            <div class="popup-changePassword__button-wrapper">
                <button class="popup-changePassword__button popup-changePassword__button-yes">Да</button>
                <button class="popup-changePassword__button popup-changePassword__button-no">Нет</button>
            </div>
        </div>
    </div>
    <div class="popup-changePassword__access">
        <div class="popup-changePassword__container">
            <h3 class="popup-changePassword__text">
                Пароль успешно сменен!
            </h3>
            <button class="popup-changePassword__button popup-changePassword__button-ok">Ок</button>
        </div>
    </div>
    <div class="popup-changePassword__fail">
        <div class="popup-changePassword__container">
            <h3 class="popup-changePassword__text">
