...
<body>
    ...
    <section class="content-liteBasic">
            <div class="content-liteBasic__container">
                <h2 class="content-liteBasic__title">Состав IP TV пакетов</h2>
                    ...
                    <div class="operator-tariffs__tab-content content-liteBasic__table">
                        <div class="operator-tariffs__wrapper content-liteBasic__table-wrapper">
                            <div class="column__wrapper column__wrapper-liteBasic">
                                <div class="column__title">матч премьер</div>
                                <div class="operator-tariffs__column column">
                                    <div class="column__item">матч! Премьер</div>
                                    <div class="column__item">матч! премьер hd</div>
                                    <div class="column__item"></div>
                                    <div class="column__item"></div>
                                    <div class="column__item"></div>
                                    <div class="column__title">ultra hd</div>
                                    <div class="column__item">ultra cinema 4k</div>
                                    <div class="column__item"></div>
                                    <div class="column__title">Пакет дождь</div>
                                    <div class="column__item">дождь</div>
                                    <div class="column__item"></div>
                                </div>
                            </div>
                            <div class="column__wrapper column__wrapper-liteBasic">
                                <div class="column__title">матч футбол</div>
                                <div class="operator-tariffs__column column">
                                    <div class="column__item">матч! футбол 1 hd</div> 
                                    <div class="column__item">матч! футбол 2 hd</div> 
                                    <div class="column__item">матч! футбол 3 hd</div>
                                    <div class="column__item"></div>
                                    <div class="column__item"></div>
                                    <div class="column__title">пакет спорт</div>
                                    <div class="column__item">русский экстрим</div>
                                    <div class="column__item">футбол</div>
                                    <div class="column__item">матч! футбол 1</div>
                            ...
                            <div class="column__wrapper column__wrapper-liteBasic">
                                <div class="column__title">настрой кино</div>
                                <div class="operator-tariffs__column column">
                                    <div class="column__item">кинопремьера</div> 
                                    <div class="column__item">кинохит</div> 
                                    <div class="column__item">киносвидание</div> 
                                    <div class="column__item">киносемья</div> 
                                    <div class="column__item">мужское кино</div>
                                    <div class="column__title">пакет клубничка</div> 
                                    <div class="column__item">о-ля-ля</div>
                                    <div class="column__item">hustler hd</div>
                                    <div class="column__title">A-media premium hd</div>
                                    <div class="column__item">A-media premium hd</div>
                                    <div class="column__item">a-media hit hd</div>
                                </div>
                            </div>
                        </div>
                        <div class="operator-tariffs__wrapper content-liteBasic__table-wrapper">
                            <div class="column__wrapper column__wrapper-liteBasic">
                                <div class="column__title">пакет детям</div>
                                <div class="operator-tariffs__column column">
                                    <div class="column__item">карусель</div>
                                    <div class="column__item">радость моя</div>
                                    <div class="column__item">образовательный</div>
                                    <div class="column__item">Nickelodeon</div>
                                    <div class="column__item">мультимания</div>
                                    <div class="column__item">cartoon network</div>
                                    ...
                                    <div class="column__item">детский</div>
                                    <div class="column__item">ani</div>
                                    <div class="column__item">o!</div>
                                    <div class="column__item"></div>
                                    <div class="column__item"></div>                                    
                                </div>
                            </div>
                            <div class="column__wrapper column__wrapper-liteBasic">
                                <div class="column__title">пакет новости</div>
                                <div class="operator-tariffs__column column">
                                    <div class="column__item">россия 24</div>
                                    <div class="column__item">Deuyche welle</div>
                                    ...
                                    <div class="column__item">Euro news</div>
                            ...
                            <div class="column__wrapper column__wrapper-liteBasic">
                                <div class="column__title">пакет кино</div>
                                <div class="operator-tariffs__column column">
                                    <div class="column__item">русский детектив</div>
                                    <div class="column__item">тнт 4</div>
                                    <div class="column__item">fox live</div>
                                    <div class="column__item">fox</div>
                                    <div class="column__item">кинопоказ</div>
                                    <div class="column__item">а1</div>
                                    <div class="column__item">а2</div>
                                    <div class="column__item">дом кино</div>
                                    <div class="column__item">русский бестселлер</div>
                                    <div class="column__item">русский роман</div>
                                    <div class="column__item">кино тв</div>
                                    <div class="column__item"></div>
                                    <div class="column__item"></div>
                                    <div class="column__item"></div>
                                    <div class="column__item"></div>
