...
<body>
    ...
    <section class="content-IPTV">
        <div class="content-IPTV__container">
            <div class="content-IPTV__text-block">
                <p class="content-IPTV__text">
                    Уважаемые абоненты! Всем, кто подключен к услуге Интернет от Теликс, предоставляется возможность подключения услуги IPTV.
                </p>
                <p class="content-IPTV__text">
                    Заявки на подключение принимаются по телефону абонентского отдела <span class="content-IPTV__text-blue">385-96-00.</span>
                </p>
            </div>
            <h2 class="content-IPTV__title">IP TV</h2>

            <div class="operator-tariffs__tab-content content-IPTV__table">
            <div class="operator-tariffs__wrapper content-IPTV__table-wrapper">
                            <div class="column__wrapper column__wrapper-IPTV">
                                ...
                                <div class="operator-tariffs__column column">
                                    <div class="column__item">лайт</div>
                                    <div class="column__item">Базовый</div>
                                    <div class="column__item">лайт + HD</div>
                                    <div class="column__item">Базовый + HD</div>
                                    <div class="column__item">Клубничка</div>
                                    <div class="column__item">Матч премьер</div>
                                    <div class="column__item">дождь</div>
                                    <div class="column__item">HD пакет</div>
                                    <div class="column__item">A-MEDIA PREMIUM HD</div>
                                    <div class="column__item">настрой кино</div>
                                    <div class="column__item">МАТЧ футбол</div>
                                    <div class="column__item">ultra hd</div>
                                    <div class="column__item">детям</div>
                                    <div class="column__item">кино</div>
                                    <div class="column__item">новости</div>
                                    <div class="column__item">кругозор</div>
                                    <div class="column__item">спорт</div>
                                    <div class="column__item">музыка</div>
                                </div>
                            </div>
                            <div class="column__wrapper column__wrapper-IPTV">
                                <div class="column__title">Стоимость</div>
                                <div class="operator-tariffs__column column">
                                    <div class="column__item">150 р/мес.</div>
                                    <div class="column__item">290 р/мес.</div>
                                    <div class="column__item">390 р/мес.</div>
                                    <div class="column__item">550 р/мес.</div>
                                    <div class="column__item">200 р/мес.</div>
                                    <div class="column__item">299 р/мес.</div>
                                    <div class="column__item">240 р/мес.</div>
                                    <div class="column__item">290 р/мес.</div>
                                    <div class="column__item">199 р/мес.</div>
                                    <div class="column__item">380 р/мес.</div>
                                    <div class="column__item">380 р/мес.</div>
                                    <div class="column__item">100 р/мес.</div>
                                    <div class="column__item">100 р/мес.</div>
                                    <div class="column__item">100 р/мес.</div>
                                    <div class="column__item">70 р/мес.</div>
                                    <div class="column__item">150 р/мес.</div>
                                    <div class="column__item">100 р/мес.</div>
                                    <div class="column__item">90 р/мес.</div>
                                </div>
                            </div>
                            <div class="column__wrapper column__wrapper-IPTV">
                                <div class="column__title">Состав пакета</div>
                                <div class="operator-tariffs__column column">
                                    <div class="column__item"><a href="liteBasic.php" class="column__item_blue">Лайт</a></div>
                                    <div class="column__item"><a href="liteBasic.php" class="column__item_blue">Базовый</a></div>
                                    <div class="column__item"><a href="liteBasicHD.php" class="column__item_blue">лайт + HD</a></div>
                                    <div class="column__item"><a href="liteBasicHD.php" class="column__item_blue">Базовый + HD</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">Клубничка</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">Матч премьер</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">дождь</a></div>
                                    <div class="column__item"><a href="outlookHD.php" class="column__item_blue">HD пакет</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">A-MEDIA PREMIUM HD</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">настрой кино</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">МАТЧ футбол</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">ultra hd</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">детям</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">кино</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">новости</a></div>
                                    <div class="column__item"><a href="outlookHD.php" class="column__item_blue">кругозор</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">спорт</a></div>
                                    <div class="column__item"><a href="containIPTV.php" class="column__item_blue">музыка</a></div>
                                </div>
                            </div>
                        </div>
            </div>
