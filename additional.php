...
<body>
    ...
    <section class="content-additional">
        <div class="content-additional__container">
            <h2 class="content-additional__title">Дополнительное обслуживание</h2>
            ...
            <div class="operator-tariffs__wrapper content-additional__table-wrapper">
                <?php 
                        ...
                        $cid = $user->cid;
                        $serviceDate = R::getAll('SELECT `date` FROM `service` WHERE `cid` = ? ORDER BY `id` ASC', array(
                            $cid
                        ));
                        $serviceComment = R::getAll('SELECT `comment` FROM `service` WHERE `cid` = ? ORDER BY `id` ASC', array(
                            $cid
                        ));
                        $serviceSum = R::getAll('SELECT `sum` FROM `service` WHERE `cid` = ? ORDER BY `id` ASC', array(
                            $cid
                        ));
                ?>
                            <div class="column__wrapper column__wrapper-IPTV">
                                ...
                                <div class="operator-tariffs__column column">
                                    <?php 
                                        for($i = 0; $i < count($serviceDate); ++$i) {
                                            echo '<div class="column__item">'. $serviceDate[$i]['date'] .'</div>';
                                        }
                                    ?>
                                </div>
                            </div>
                            <div class="column__wrapper column__wrapper-IPTV">
                                ...
                                <div class="operator-tariffs__column column">
                                    <?php 
                                        for($i = 0; $i < count($serviceSum); ++$i) {
                                            echo '<div class="column__item">'. $serviceSum[$i]['sum'] .'</div>';
                                        }
                                    ?>
                                </div>
                            </div>
                            <div class="column__wrapper column__wrapper-IPTV">
                                ...
                                <div class="operator-tariffs__column column">
                                    <?php 
                                        for($i = 0; $i < count($serviceComment); ++$i) {
                                            echo '<div class="column__item">'. $serviceComment[$i]['comment'] .'</div>';
                                        }
                                    ?>
                                </div>
                            </div>
