...
<?php 
	$errors = array();
	$user = R::findOne('contract', 'cid = ?', array($data['cid']));
?>
<!DOCTYPE html>
<html lang="ru">
...
<body>
	...
	<?php //if(password_verify($data['tid'], $user->tid)) :
    ...
    <main class="main">
        <section class="profile-entrance">
            <div class="profile-entrance__container">
                <div class="profile-entrance__title-wrapper">
                    <h2 class="profile-entrance__title">
                        Личный кабинет
                    </h2>
                </div>
                <?php
				...
				?>
                <form action="profile.php" method="POST" class="profile-entrance__form">
                    <label for="entrance-number" class="profile-entrance__number-label">
                        <h3 class="profile-entrance__number-caption">Номер договора:</h3>
                        <input type="text" class="profile-entrance__number" id='entrance-number' name="cid" placeholder="0000 - 000 - 000 - 000" <?php echo @$data['cid'];?>>
                    </label>
                    <label for="entrance-password" class="profile-entrance__password-label">
                        <h3 class="profile-entrance__password-caption">Пароль:</h3>
                        <input type="password" class="profile-entrance__password"  name="pass" id='entrance-password' placeholder="**************" <?php echo @$data['pass'];?>>
                    </label>    
                    <input type="submit" class="profile-entrance__submit" name ="do_login" value="Войти"/>
                </form>
            </div>
        </section>
    </main>
    ...
    <div class="mainScreen">
        <div class="container mainScreen__container mainScreen__container-profile">
            ...
            <ul class="menu">
                    <li class="menu__item"><a class="menu__link" href="index.php">
                            <img class="menu__img" src="img/mainScreen/menu/main.svg" alt="home">
                            <img class="menu__img_hover" src="img/mainScreen/menu/main-hover.svg" alt="">
                            <span class="menu__item-span">Главная</span></a></li>
                    <li class="menu__item"><a class="menu__link" href="operator.php">
                            <img class="menu__img" src="img/mainScreen/menu/operator.svg" alt="operator">
                            <img class="menu__img_hover" src="img/mainScreen/menu/operator-hover.svg" alt="">
                            <span class="menu__item-span">Оператор</span></a></li>
                    <li class="menu__item"><a class="menu__link" href="contractor.php">
                            <img class="menu__img" src="img/mainScreen/menu/contractor.svg" alt="">
                            <img class="menu__img_hover" src="img/mainScreen/menu/contractor-hover.svg" alt="">
                            <span class="menu__item-span">Подрядчик</span></a></li>
                    <li class="menu__item"><a class="menu__link link-about">
                            <img class="menu__img" src="img/mainScreen/menu/info.svg" alt="">
                            <img class="menu__img_hover" src="img/mainScreen/menu/info-hover.svg" alt="">
                            <span class="menu__item-span">О компании</span></a></li>
                    <li class="menu__item"><a class="menu__link link-contacts">
                            <img class="menu__img" src="img/mainScreen/menu/contacts.svg" alt="">
                            <img class="menu__img_hover" src="img/mainScreen/menu/contacts-hover.svg" alt="">
                            <span class="menu__item-span">Контакты</span></a></li>
                </ul>
            </nav>
        </div>
