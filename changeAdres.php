...
<body>
    ...
    <section class="content-changeAdres">
        <div class="content-changeAdres__container">
            <h2 class="content-changeAdres__title">Смена адрес</h2>

            <div class="content-changeAdres__form">
                <h3 class="content-changeAdres__form-title">введите новый адрес:</h3>
                <input type="text" class="content-changeAdres__form-input">
                <div class="content-changeAdres__form-button-wrapper">
                    <button class="content-changeAdres__form-button">Сохранить</button>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="popup-changeAdres__layer"></div>
    <div class="popup-changeAdres">
        <div class="popup-changeAdres__container">
            <h3 class="popup-changeAdres__text">
                Вы уверены, что хотите сменить адрес?
            </h3>
            <div class="popup-changeAdres__button-wrapper">
                <button class="popup-changeAdres__button popup-changeAdres__button-yes">Да</button>
                <button class="popup-changeAdres__button popup-changeAdres__button-no">Нет</button>
            </div>
        </div>
    </div>
    <div class="popup-changeAdres__access">
        <div class="popup-changeAdres__container">
            <h3 class="popup-changeAdres__text">
                адрес успешно сменен!
            </h3>
            <button class="popup-changeAdres__button popup-changeAdres__button-ok">Ок</button>
        </div>
    </div>
    <div class="popup-changeAdres__fail">
        <div class="popup-changeAdres__container">
            <h3 class="popup-changeAdres__text">
                Не удалось сменить адрес
            </h3>
            <button class="popup-changeAdres__button popup-changeAdres__button-ok">Ок</button>
        </div>
    </div>
